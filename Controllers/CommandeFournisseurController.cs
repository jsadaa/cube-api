...
namespace ApiCube.Controllers
{
    ...
    public class CommandeFournisseurController : ControllerBase
    {
        ...
        /// <response code="400">format_date_commande_invalide | format_date_livraison_invalide | statut_invalide | fournisseur_invalide | employe_invalide | ligne_commande_fournisseur_invalide</response>
